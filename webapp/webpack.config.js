...
const devBabelPlugins = [
  "@loadable/babel-plugin", // route에서 lodable로 페이지 별로 코드 스플릿팅하면서 SSR를 준비를 위한 플러그인
  // "@babel/plugin-syntax-dynamic-import", dynamic import를 위한 플러그인 preset (@babel/preset-env, in ES2020)
